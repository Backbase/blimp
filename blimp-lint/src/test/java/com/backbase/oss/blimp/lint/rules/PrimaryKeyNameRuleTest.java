...
class PrimaryKeyNameRuleTest extends AbstractRuleTest {

    PrimaryKeyNameRuleTest() {
        super(PrimaryKeyNameRule.NAME, PrimaryKeyNameRule.class, PrimaryKeyAddNameRule.class);
    }
    ...
    void matchesRequired() throws LiquibaseException {
        setLintProperty(AbstractRuleConfiguration.REQUIRED, "true");
        setLintProperty(AbstractRuleConfiguration.MATCHES, "pk_.+");
