...
class ForeignKeyNameRuleTest extends AbstractRuleTest {

    ForeignKeyNameRuleTest() {
        super(ForeignKeyNameRule.NAME, ForeignKeyNameRule.class, ForeignKeyAddNameRule.class);
    }
    ...
    void matchesRequired() throws LiquibaseException {
        setLintProperty(AbstractRuleConfiguration.REQUIRED, "true");
        setLintProperty(AbstractRuleConfiguration.MATCHES, "fk_.+");
